...
class UpdateSettingsUseCase @Inject constructor(
    ...
    fun setFloatingMenuCreateVisible(enabled: Boolean) = repository.setFloatingMenuCreateVisible(enabled)
    fun setFloatingMenuFilterVisible(enabled: Boolean) = repository.setFloatingMenuFilterVisible(enabled)
    fun setFloatingMenuSelectVisible(enabled: Boolean) = repository.setFloatingMenuSelectVisible(enabled)
    fun setTopMenuCreateVisible(enabled: Boolean) = repository.setTopMenuCreateVisible(enabled)
    fun setTopMenuGridVisible(enabled: Boolean) = repository.setTopMenuGridVisible(enabled)
    fun setTopMenuFilterVisible(enabled: Boolean) = repository.setTopMenuFilterVisible(enabled)
    fun setTopMenuEmptyVisible(enabled: Boolean) = repository.setTopMenuEmptyVisible(enabled)
    fun setTopMenuSelectVisible(enabled: Boolean) = repository.setTopMenuSelectVisible(enabled)
    fun setShowVaultInCarousel(enabled: Boolean) = repository.setShowVaultInCarousel(enabled)
    fun setLockSettingsScreen(enabled: Boolean) = repository.setLockSettingsScreen(enabled)
}
